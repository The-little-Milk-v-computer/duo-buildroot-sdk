...
int cvi_board_init(void)
{
	...
	// SPI
	PINMUX_CONFIG(SPI3_SCK,XGPIOB_15);
	PINMUX_CONFIG(SPI3_SDO,XGPIOB_13);
	PINMUX_CONFIG(SPI3_SDI,XGPIOB_14);
	PINMUX_CONFIG(SPI3_CS,XGPIOA_28);
	pinmux_config(PINMUX_SPI3);
